  ...
  const services = [
    {
      ...
      description: "Deploy Gemini Live-native agents that manage complex logic, emotional intelligence, and real-time execution with zero latency. It's not a bot; it's an elite team member.",
      icon: (
    ...
    },
    {
      ...
      description: "Replace brittle manual processes with self-healing autonomous workflows. We transform operational bottlenecks into streamlined, high-velocity assets that work 24/7/365.",
      icon: (
        <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Stop looking at the past. Our automated executive reporting engine synthesizes live data streams into actionable strategy, identifying opportunities before your competitors do.",
      icon: (
        <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid lg:grid-cols-3 items-end gap-12 mb-20">
          ...
          <div>
            <p className="text-gray-500 font-light border-l border-indigo-500/30 pl-6">
              We specialize in the high-stakes integration of Gemini-native technology for businesses where downtime is not an option.
            </p>
          </div>
        </div>
