        ...
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-2">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3 text-sm text-gray-300">
                ...
                <a href="mailto:timothy@adversityai.com" className="hover:text-indigo-400 transition-colors">timothy@adversityai.com</a>
              </div>
              <div className="flex items-center space-x-3 text-sm text-gray-300">
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-400 text-sm">
              <li><a href="#services" className="hover:text-white transition-colors">Voice Orchestration</a></li>
              <li><a href="#services" className="hover:text-white transition-colors">Workflow Hardening</a></li>
              <li><a href="#gallery" className="hover:text-white transition-colors">Predictive Reporting</a></li>
              <li><a href="#contact" className="hover:text-white transition-colors">Custom AI Integration</a></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-4 text-gray-400 text-sm">
              ...
              <li><a href="mailto:timothy@adversityai.com" className="hover:text-white transition-colors">Contact</a></li>
            </ul>
          </div>
        </div>
